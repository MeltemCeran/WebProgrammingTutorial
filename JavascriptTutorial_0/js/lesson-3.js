...
function MetinselOrnekler() {
  ...
  console.log(
    "bugün yarın iki dün ısı yağmur çamur ördek".toLocaleUpperCase("tr")
  );
...
function KararYapilari() {
  ...
  if (sayi > 5) console.log("5 den büyük");
  else if (sayi == 5) console.log("5");
  else console.log("5 den küçük");
